...
import 'package:postgres/postgres.dart' as _i6;
import 'package:todo_app_backend/core/config/database_config.dart' as _i11;
import 'package:todo_app_backend/core/datasource/datasource.dart' as _i3;
import 'package:todo_app_backend/core/datasource/remote_datasource_impl.dart' as _i4;
import 'package:todo_app_backend/core/jwt/jwt_service.dart' as _i5;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i3.DataSource>(_i4.RemoteDataSourceImpl());
    gh.singleton<_i5.JwtService>(_i5.JwtServiceImpl());
    await gh.factoryAsync<_i6.PostgreSQLConnection>(
      () => registerModule.database(),
      preResolve: true,
    );
    gh.singleton<_i7.TaskRepository>(_i8.TaskRepositoryImpl());
